...
function RunDemo() {
  ...
  PaperOffset.offset(r, 10, offsetOptions)
  r.bringToFront()
  PaperOffset.offset(PaperOffset.offset(PaperOffset.offset(r, -10,offsetOptions), -10, offsetOptions), -10, offsetOptions);
  ...
  let r12 = PaperOffset.offset(r11, -10, {...offsetOptions, insert: false})
  let r1 = r11.subtract(r12, {insert: true})
  r11.remove()
  PaperOffset.offset(r1, 15, {...offsetOptions, join: 'bevel'})
  r1.bringToFront()
  ...
  let r22 = PaperOffset.offset(r21, -10, {...offsetOptions, insert: false})
  let r2 = r21.subtract(r22, { insert: true })
  r21.remove()
  PaperOffset.offset(r2, 15, {...offsetOptions, join: 'round' })
  r2.bringToFront()
  ...
  PaperOffset.offset(s, 10, offsetOptions)
  s.bringToFront()
  PaperOffset.offset(PaperOffset.offset(s, -10, offsetOptions), -10, offsetOptions);

  // smooth
  let s2 = new paper.Path.Star({ center: [-150, -260], points: 7, radius1: 40, radius2: 30, fillColor: 'rgba(239, 209, 88, 0.5)', strokeColor: 'black' })
  s2.smooth()
  PaperOffset.offset(s2, 10, offsetOptions);
  s2.bringToFront()
  PaperOffset.offset(PaperOffset.offset(s2, -10, offsetOptions), -10, offsetOptions)
  ...
  c1.remove()
  c2.remove()
  PaperOffset.offset(c, 10, offsetOptions);
  c.bringToFront()
  PaperOffset.offset(PaperOffset.offset(PaperOffset.offset(c, -10, offsetOptions), -10, offsetOptions), -10, offsetOptions)
  ...
  c5.remove()
  cc1.remove()
  PaperOffset.offset(cc, 10, offsetOptions)
  cc.bringToFront()
  PaperOffset.offset(PaperOffset.offset(PaperOffset.offset(PaperOffset.offset(cc, -10, offsetOptions), -10, offsetOptions), -10, offsetOptions), -5, offsetOptions)
  ...
  ccc1.remove()
  ccc.smooth()
  PaperOffset.offset(ccc, 10, offsetOptions)
  ccc.bringToFront()
  PaperOffset.offset(PaperOffset.offset(ccc, -10, offsetOptions), -10, offsetOptions)
  PaperOffset.offset(PaperOffset.offset(ccc, -30, offsetOptions), -5, offsetOptions)

  // stroke
  let rs = new paper.Path.Rectangle({ point: [-200, -150], size: [80, 80], fillColor: null, strokeColor: 'rgb(191, 91, 91, 0.5)' })
  PaperOffset.offsetStroke(rs, 10, offsetOptions)
  rs.bringToFront()

  // stroke
  let st1 = new paper.Path.Line({ from: [-50, -100], to: [0, -100], strokeColor: 'rgba(156, 104, 193, 0.5)', strokeWidth: 3 })
  PaperOffset.offsetStroke(st1, 20, {...offsetOptions, cap: 'round' })
  st1.bringToFront()
  ...
  cs.position = [150, -50]
  cs.closed = false
  PaperOffset.offsetStroke(cs, 20, offsetOptions)
  cs.bringToFront()
  let cs2 = cs.clone()
  cs2.position = [400, -50]
  cs2.strokeColor = 'rgba(117, 170, 173, 0.5)'
  PaperOffset.offsetStroke(cs2, 25, {...offsetOptions, cap: 'round' })
  cs2.bringToFront()
  ...
  ec1.scale(0.4)
  PaperOffset.offset(ec1, 10, offsetOptions)
  PaperOffset.offset(PaperOffset.offset(PaperOffset.offset(ec1, -10, offsetOptions), -10, offsetOptions), -10, offsetOptions)
  ...
  PaperOffset.offsetStroke(ec2, 10, offsetOptions)
  ...
  PaperOffset.offset(ec3, -10, offsetOptions)
}
